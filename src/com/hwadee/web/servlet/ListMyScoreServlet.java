 ...
 * @Author LH
 * @Description 成绩单
 * @Date Create in 14:06 2020/7/22
 */
@WebServlet("/ListMyScoreServlet")
public class ListMyScoreServlet extends HttpServlet {
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        PageBean<Score> pageBean = service.findMyScoreList(Integer.parseInt(currentpage), Integer.parseInt(rows),sno);
        request.setAttribute("pageBean",pageBean);
//        System.out.println(pageBean);
        request.getRequestDispatcher("/student/student_score.jsp").forward(request, response);
